...
public class Launcher {
  ...
  public static void main(String[] arguments) {
    ...
    for (
      int index = 0;
      index < application_arguments.length;
      ++index
  ...
  private static void usage() {
    ...
    for (int index = 0; index < names.length; ++index) System.out.print(
      " " + names[index]
    );
    ...
    System.out.println(
      "\nfor example, the arguments to start a storage " + "server:"
    );
