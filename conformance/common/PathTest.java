...
public class PathTest extends Test {
  ...
  private void testListing() throws TestFailed {
    ...
    try {
      ...
      if (!TestUtil.sameElements(listed, expected)) throw new TestFailed(
      ...
      if (directory != null) directory.remove();
    }
  }
  ...
  private void testConstructors() throws TestFailed {
    ...
    try {
      ...
      throw new TestFailed(
        "Path(Path, String) constructor accepted " + "empty string"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (IllegalArgumentException e) {} catch (Throwable t) {
      throw new TestFailed(
        "Path(Path, String) constructor threw " +
    ...
    try {
      ...
      throw new TestFailed(
        "Path(Path, String) constructor accepted " +
    ...
    try {
      ...
      throw new TestFailed(
        "Path(Path, String) constructor accepted " + "string containing a colon"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (IllegalArgumentException e) {} catch (Throwable t) {
    ...
    try {
      new Path("some-file");
      throw new TestFailed(
        "Path(String) constructor accepted string " +
      ...
      throw new TestFailed(
        "Path(String) constructor threw unexpected " +
    ...
    try {
      ...
      throw new TestFailed(
        "Path(String) constructor accepted string " + "containing a colon"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (IllegalArgumentException e) {} catch (Throwable t) {
    ...
    try {
      new Path("");
      throw new TestFailed(
        "Path(String) constructor accepted empty " + "string"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (IllegalArgumentException e) {} catch (Throwable t) {
      throw new TestFailed(
        "Path(String) constructor threw unexpected " +
        "exception when given empty string",
        t
      );
    }
    ...
    try {
      ...
      if (!root.toString().equals("/")) {
        throw new TestFailed(
          "string representation of root path " + "incorrect"
        );
      }
      ...
      if (!child.toString().equals("/subdir")) throw new TestFailed(
        "string representation of path incorrect"
      );
      ...
      if (!alternative_child.toString().equals("/subdir")) throw new TestFailed(
        "string representation of path incorrect"
      );
      ...
      if (!third_child.toString().equals("/subdir")) throw new TestFailed(
        "string representation of path incorrect"
      );

      if (!root.equals(alternative_root)) throw new TestFailed(
        "root directories not equal"
      );

      if (!child.equals(alternative_child)) throw new TestFailed(
        "same children not equal"
      );

      if (!child.equals(third_child)) throw new TestFailed(
        "same children not equal"
      );

      if (root.equals(child)) throw new TestFailed(
        "child and root should not be equal"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
  ...
  private void testSplitting() throws TestFailed {
    try {
      ...
      if (!root.isRoot()) throw new TestFailed(
        "root path not reported as root"
      );
      ...
      try {
        ...
        throw new TestFailed(
          "unexpected error while checking that " +
      ...
      try {
        ...
        throw new TestFailed(
          "unexpected error while checking that " +
          "root directory has no last component",
          t
        );
      }
      ...
      if (descendant.isRoot()) throw new TestFailed("path reported as root");

      try {
        if (
          !descendant.parent().equals(new Path("/subdirectory"))
        ) throw new TestFailed("parent directory incorrect");
      } catch (TestFailed e) {
        throw e;
      } catch (Throwable t) {
        throw new TestFailed(
          "unexpected error while checking that " + "path has parent path",
          t
        );
      }

      try {
        if (!descendant.last().equals("file")) throw new TestFailed(
          "last component incorrect"
        );
      } catch (TestFailed e) {
        throw e;
      } catch (Throwable t) {
        throw new TestFailed(
          "unexpected error while checking that " + "path has last component",
          t
        );
      }
    } catch (TestFailed e) {
  ...
  private void testSubpaths() throws TestFailed {
    ...
    if (path.isSubpath(new Path("/directory2"))) {
      throw new TestFailed(
        "path that is not a prefix reported as " + "subpath"
      );
    }

    if (!(path.isSubpath(new Path("/directory")))) throw new TestFailed(
      "proper prefix is not reported as subpath"
    );

    if (path.isSubpath(new Path("/directory/file/file"))) throw new TestFailed(
      "longer path reported as subpath"
    );

    if (!(path.isSubpath(new Path("/directory/file")))) throw new TestFailed(
      "path not reported as subpath of itself"
    );

    if (!(path.isSubpath(new Path("/")))) throw new TestFailed(
      "root not reported as subpath"
    );
  }
  ...
  private void testIterator() throws TestFailed {
    ...
    while (components.hasNext()) {
      ...
      if (
        !component.equals(component_array[component_index])
    ...
    if (component_index < component_array.length) throw new TestFailed(
      "iterator did not exhaust all components"
    );
