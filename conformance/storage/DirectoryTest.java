...
public class DirectoryTest extends StorageTest {
  ...
  private void testCreate() throws TestFailed {
    ...
    try {
      ...
      throw e;
    } catch (NullPointerException e) {} catch (Throwable t) {
      throw new TestFailed(
        "create threw unexpected exception when " + "given null as argument",
        t
      );
    }
    ...
    try {
      if (command_stub.create(new Path("/"))) {
        throw new TestFailed("create accepted root directory as " + "argument");
      }
    } catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
      throw new TestFailed(
        "create threw unexpected exception when " +
        "given root directory as argument",
        t
      );
    }

    // Attempt to call create with a file under an existing directory
    try {
      if (!command_stub.create(new Path("/subdirectory/file3"))) {
        throw new TestFailed(
          "couldn't create a file under an existing directory"
        );
      }
    } catch (TestFailed e) {
      throw e;
    ...
    try {
      if (command_stub.create(new Path("/file3"))) {
        throw new TestFailed(
          "create succeeded when given existing " + "file as argument"
        );
      }
    } catch (TestFailed e) {
      throw e;
      ...
      throw new TestFailed(
        "create threw unexpected exception when " +
        "given existing file as argument",
        t
      );
    }
    ...
    try {
      if (!command_stub.create(create_path)) throw new TestFailed(
      ...
      throw new TestFailed(
        "create threw unexpected exception when " + "creating new file",
        t
      );
    }
    ...
    if (!local_file.isDirectory()) throw new TestFailed(
      "created path component is not a directory"
    );
    ...
    if (!local_file.exists()) {
      throw new TestFailed(
        "created file is not present in server " + "storage directory"
      );
    }
    ...
    try {
      if (!command_stub.create(root_create_path)) {
        throw new TestFailed(
          "unable to create new file in root " + "directory"
        );
      }
    } catch (TestFailed e) {
      throw e;
  ...
  private void testDelete() throws TestFailed {
    ...
    try {
      ...
      throw new TestFailed(
        "delete threw unexpected exception when " + "given null as argument",
        t
      );
    }
    ...
    try {
      if (command_stub.delete(new Path("/"))) {
        throw new TestFailed("delete accepted root directory as " + "argument");
      }
    } catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
      throw new TestFailed(
        "delete threw unexpected exception when " +
        "given root directory as argument",
        t
      );
    }
    ...
    try {
      if (command_stub.delete(new Path("/absent-file"))) {
        throw new TestFailed(
          "delete succeeded when given " + "non-existent file as argument"
        );
      }
    } catch (TestFailed e) {
      throw e;
    ...
    // fileystem.
    try {
      if (!command_stub.delete(new Path("/file3"))) throw new TestFailed(
      ...
      throw new TestFailed(
        "delete threw unexpected exception when " + "deleting regular file",
        t
      );
    }
    ...
    if (deleted_file.exists()) throw new TestFailed(
      "deleted file still present in filesystem"
    );

    // Repeat the same test with a directory.
    try {
      if (!command_stub.delete(new Path("/subdirectory"))) throw new TestFailed(
      ...
      throw new TestFailed(
        "delete threw unexpected exception when " + "deleting directory",
        t
      );
    }
    ...
    if (deleted_directory.exists()) throw new TestFailed(
      "deleted directory still present in filesystem"
    );
  }
}
