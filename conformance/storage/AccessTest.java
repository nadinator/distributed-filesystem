...
public class AccessTest extends StorageTest {
  ...
  private final Path read_write_file = new Path("/subdirectory/file1");
  ...
  private void testReadWrite() throws TestFailed {
    ...
    // size.
    File direct_access = new File(directory.root(), "subdirectory");
    direct_access = new File(direct_access, "file1");

    if (!direct_access.exists()) throw new TestFailed(
      "file does not exist after writing"
    );

    if (direct_access.isDirectory()) throw new TestFailed(
      "file is a directory after writing"
    );

    if (direct_access.length() != write_data.length) throw new TestFailed(
      "file has incorrect size after writing"
    );
    ...
    try {
      ...
      throw new TestFailed(
        "unable to open written file directly for " + "reading",
        t
      );
    }
    ...
    try {
      ...
      if (stream.read(local_data, 0, write_data.length) != write_data.length) {
        throw new TestFailed(
          "end of file reached while reading " + "written data directly"
        );
      }
    } catch (IOException e) {
    ...
    if (!Arrays.equals(local_data, write_data)) {
      throw new TestFailed(
        "data retrieved from written file directly " +
    ...
    try {
      if (client_stub.size(read_write_file) != write_data.length) {
        throw new TestFailed(
          "stub reports incorrect file size after " + "data is written to file"
        );
      }
    } catch (TestFailed e) {
      throw e;
      ...
      throw new TestFailed(
        "unable to retrieve written file size " + "through stub",
        t
      );
    }

    try {
      byte[] remote_data = client_stub.read(
        read_write_file,
        0,
        write_data.length
      );
      ...
      if (!Arrays.equals(remote_data, write_data)) {
        throw new TestFailed(
          "data retrieved through stub from " +
      ...
      throw new TestFailed(
        "unable to retrieve written file contents " + "through stub",
        t
      );
    }
  }
  ...
  private void testReadWriteBounds() throws TestFailed {
    ...
    try {
      ...
      throw e;
    } catch (IndexOutOfBoundsException e) {} catch (Throwable t) {
      throw new TestFailed(
        "read method raised unexpected exception " +
        "when reading from negative offset",
        t
      );
    }
    ...
    try {
      ...
      throw new TestFailed("read method allowed reading past end of " + "file");
    } catch (TestFailed e) {
      throw e;
    } catch (IndexOutOfBoundsException e) {} catch (Throwable t) {
      throw new TestFailed(
        "read method raised unexpected exception " +
        "when reading past end of file",
        t
      );
    }

    try {
      client_stub.read(read_write_file, write_data.length, write_data.length);
      ...
      throw new TestFailed(
        "read method raised unexpected exception " +
        "when offset is outside of file",
        t
      );
    }
    ...
    try {
      ...
      throw new TestFailed(
        "read method allowed read with negative " + "length"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (IndexOutOfBoundsException e) {} catch (Throwable t) {
    ...
    try {
      ...
      throw new TestFailed(
        "write method allowed write with negative " + "offset"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (IndexOutOfBoundsException e) {} catch (Throwable t) {
      throw new TestFailed(
        "write method raised unexpected exception " +
        "when given negative offset",
        t
      );
    }
  }
  ...
  private void testAppend() throws TestFailed {
    ...
    try {
      client_stub.write(read_write_file, write_data.length + 1, write_data);
    } catch (Throwable t) {
    ...
    try {
      ...
      throw new TestFailed(
        "unable to retrieve file size after " + "appending",
        t
      );
    }

    if (size != write_data.length + 1 + write_data.length) throw new TestFailed(
      "file has incorrect size after appending"
    );
  }
  ...
  private void testSize() throws TestFailed {
    ...
    } catch (FileNotFoundException e) {} catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
      throw new TestFailed(
        "size method threw unexpected exception " +
    ...
    try {
      ...
      throw new TestFailed(
        "size method threw unexpected exception " + "when accessing directory",
        t
      );
    }
    ...
    try {
      if (client_stub.size(empty_file) != 0) {
        throw new TestFailed(
          "size method returned nonzero result " + "for empty file"
        );
      }
    } catch (TestFailed e) {
      throw e;
      ...
      throw new TestFailed(
        "size method threw unexpected exception " + "when accessing empty file",
        t
      );
    }
    ...
    try {
      ...
      throw new TestFailed(
        "size method returned when given null as " + "argument"
      );
    } catch (NullPointerException e) {} catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
      throw new TestFailed(
        "size method threw unexpected exception " +
        "when given null as argument",
        t
      );
    }
  }
  ...
  private void testReadBasic() throws TestFailed {
    ...
    try {
      ...
      throw new TestFailed(
        "read method threw unexpected exception " +
        "when accessing non-existent file",
        t
      );
    }
    ...
    try {
      ...
      throw new TestFailed(
        "read method threw unexpected exception " + "when accessing directory",
        t
      );
    }
    ...
    try {
      ...
      if (result == null) {
        throw new TestFailed(
          "read method returned null when reading " + "from empty file"
        );
      }

      if (result.length != 0) {
        throw new TestFailed(
          "read method returned incorrect number " +
    ...
    try {
      ...
      throw new TestFailed(
        "read method returned when given null as " + "argument"
      );
    } catch (NullPointerException e) {} catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
  ...
  private void testWriteBasic() throws TestFailed {
    ...
    try {
      ...
      throw new TestFailed(
        "write method threw unexpected exception " +
        "when accessing non-existent file",
        t
      );
    }
    ...
    try {
      ...
      throw new TestFailed(
        "write method threw unexpected exception " + "when accessing directory",
        t
      );
    }
    ...
    try {
      ...
      throw new TestFailed(
        "write method returned when given null for " + "path argument"
      );
    } catch (NullPointerException e) {} catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
      throw new TestFailed(
        "write method threw unexpected exception " +
        "when given null for path argument",
        t
      );
    }
    ...
    try {
      ...
      throw new TestFailed(
        "write method returned when given null for " + "data argument"
      );
    } catch (NullPointerException e) {} catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
      throw new TestFailed(
        "write method threw unexpected exception " +
        "when given null for data argument",
        t
      );
    }
  }
