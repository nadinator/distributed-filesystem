...
public class StubTest extends Test {
  ...
  protected void initialize() throws TestFailed {
    address = new InetSocketAddress(8080); // 7000
    listening = true;
  ...
  private void ensureStubConnects() throws TestFailed {
    ...
    try {
      ...
      throw new TestFailed(
        "unable to create stub for connecting to " + "test server",
        t
      );
    }
    ...
    try {
      ...
      throw new TestFailed(
        "unable to bind listening socket to " + "address",
        e
      );
    }
    ...
    try {
      ...
      throw new TestFailed(
        "exception when attempting to connect to " + "server",
        t
      );
    }
  ...
  private void ensureUnknownHostRejected() throws TestFailed {
    try {
      ...
      throw new TestFailed(
        "Stub.create(Class<T>, Skeleton<T>) allowed " +
        "stub to be created from skeleton with " +
        "unassigned address"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (IllegalStateException e) {} catch (Throwable t) {
      throw new TestFailed(
        "Stub.create(Class<T>, Skeleton<T>) threw " +
        "an unexpected exception when given a " +
        "skeleton with an unassigned address",
        t
      );
    }
  }
  ...
  private void ensureClassRejected() throws TestFailed {
    try {
      ...
      throw new TestFailed(
        "Stub.create(Class<T>, InetSocketAddress) " + "has accepted a class"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (Error e) {} catch (Throwable t) {
      throw new TestFailed(
        "Stub.create(Class<T>, InetSocketAddress) " +
  ...
  private void ensureNonRemoteInterfaceRejected() throws TestFailed {
    try {
      ...
      throw new TestFailed(
        "Stub.create(Class<T>, InetSocketAddress) " +
        "constructor threw an unexpected exception " +
        "when given a non-remote interface",
        t
      );
    }
  }
  ...
  private void ensureNullPointerExceptions() throws TestFailed {
    ...
    try {
      ...
      throw new TestFailed(
        "Stub.create(Class<T>, Skeleton<T>) " +
    ...
    try {
      ...
      throw new TestFailed(
        "Stub.create(Class<T>, Skeleton<T>, String) " +
        "accepted null for first argument"
      );
    } catch (TestFailed e) {
      throw e;
    ...
    try {
      TestInterface stub = Stub.create(
        TestInterface.class,
        (Skeleton<TestInterface>) null
      );
      throw new TestFailed(
        "Stub.create(Class<T>, Skeleton<T>) " +
    ...
    // third argument.
    try {
      TestInterface stub = Stub.create(TestInterface.class, skeleton, null);
      throw new TestFailed(
        "Stub.create(Class<T>, Skeleton<T>, String) " +
  ...
  private void ensureLocalMethods() throws TestFailed {
    ...
    // other two stubs).
    TestInterface stub3 = Stub.create(
      TestInterface.class,
    ...
    try {
      if (stub1.equals(null)) throw new TestFailed(
        "stub is reported as equal to null"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
      throw new TestFailed(
        "equals threw an unexpected exception when " +
        "comparing a stub to null",
        t
      );
    }
    ...
    try {
      if (!stub1.equals(stub2)) {
        throw new TestFailed("stubs for the same skeleton are not " + "equal");
      }
    } catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
      throw new TestFailed(
        "equals threw an unexpected exception when " + "comparing equal stubs",
        t
      );
    }
    ...
    try {
      if (stub1.equals(stub3)) throw new TestFailed(
        "stubs for different skeletons are equal"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
    ...
    try {
      if (stub1.hashCode() != stub2.hashCode()) throw new TestFailed(
        "equal stubs have different hash codes"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
    ...
    try {
      if (stub1.hashCode() == stub3.hashCode()) throw new TestFailed(
        "unequal stubs have the same hash code"
      );
    } catch (TestFailed e) {
      throw e;
    } catch (Throwable t) {
  ...
  private class ConnectionCheckThread implements Runnable {
    ...
    public void run() {
      try {
        ...
        failure(
          new TestFailed(
            "caught an exception while listening " + "for a connection",
            e
          )
        );
      }
