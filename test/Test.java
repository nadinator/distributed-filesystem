...
public abstract class Test {
  ...
  public void success() {
    if (state == null) {
      throw new IllegalStateException(
        "test success method called " + "while test is being constructed"
      );
    }
  ...
  public void failure(Throwable reason) {
    if (state == null) {
      throw new IllegalStateException(
        "test failure method called " + "while test is being constructed"
      );
    }
  ...
  public void cleanupFailure(Throwable reason) {
    ...
    state.stopCleanup(
      new FatalError(
        "cleanup failed with explicit call " + "to cleanupFailure",
        reason
      )
    );
  }
  ...
  public void task(String description) {
    if (state == null) {
      throw new IllegalStateException(
        "test task method called while " + "test is being constructed"
      );
    }
