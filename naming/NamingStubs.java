...
public abstract class NamingStubs {
  ...
  // The default address of the Naming Server (bottom of handout pg.7)
  public static final int SERVICE_PORT =
    6000;/** Default naming server client service port. */
  public static final int REGISTRATION_PORT =
    6001;/** Default naming server registration port. */
